     ...
     const navigate=useNavigate()
      ...
      useEffect(() => {
        if (selectedSort == sortOptions[0]) {
          const sortProducts = [...currentProducts].filter((product) => product.cart >0).sort((a, b) => a.price - b.price);
          setCurrentProducts(sortProducts);
        } else if (selectedSort == sortOptions[1]) {
          const sortProducts = [...currentProducts].filter((product) => product.cart >0).sort((a, b) => b.price - a.price);
          setCurrentProducts(sortProducts);
        } 
